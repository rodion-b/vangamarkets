// Vanga Markets demo exchange. Everything runs in the browser: prices tick on a
...
(() => {
  ...
  const LANG_KEY = "vangamarkets-lang";
  const STATE_KEY = "vangamarkets-demo-v1";
  ...
  function render() {
    ...
    if (route.view === "event") {
      ...
      if (!event) {
        ...
        updateTradeSummary();
        title = `${tx(event.title)} · Vanga Markets`;
      }
      ...
      title = `${t("howTitle")} · Vanga Markets`;
    } else {
